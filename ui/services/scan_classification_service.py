...
def classify_scan_records(
    ...
    *,
    ...
    excel_contract_nos = {row.contract_no for row in contract_book.valid_rows}
    web_contract_nos = {normalize_contract_no_for_compare(value) for value in existing_web_contract_nos}
    ...
    for record in records:
        ...
        matched_valid_contract_nos.add(normalized_contract_no)

    excel_missing_in_folder = sorted(
        (contract_no for contract_no in excel_contract_nos if contract_no not in matched_valid_contract_nos),
